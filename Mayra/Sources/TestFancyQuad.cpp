...
namespace Test
{
    TestFancyQuad TestFancyQuad::m_Instance;

    void TestFancyQuad::OnUpdate(TestsManager*, float)
    {

    }

    void TestFancyQuad::Suspend()
    {

    }

    void TestFancyQuad::Resume()
    {

    }

    void TestFancyQuad::OnAttach()
    {
    ...
    void TestFancyQuad::OnRender(TestsManager*)
    {
    ...
    void TestFancyQuad::OnImGuiRender(TestsManager* testsManager)
    {
