...
namespace Mayra
{
    ...
    : m_ClearColor(glm::vec4(62.0f / 255.0f, 61.0f / 255.0f, 64.0f / 255.0f, 1.0f))
    {
        ...
        m_ModelShader = new Shader(SHADERS "Animation.vert", SHADERS "Animation.frag");
        stbi_set_flip_vertically_on_load(false);
        m_Model = new Model(MODELS "dance/Swing.fbx");
    }

    void AnimationScene::OnUpdate(float deltaTime)
    {
        if (m_Playmode)
        {
    ...
    void AnimationScene::OnImGuiRender()
    {
